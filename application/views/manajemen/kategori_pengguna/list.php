            ...
            <div class='row m-0'>
                <div class='col-12 my-2'>
                    <h3 class="d-flex justify-content-between text-darkblue">
                        ...
                        <div class="font-weight-semibold">Kategori Pengguna</div>
                        <a href="<?= site_url('manajemen/kategori_pengguna/tambah') ?>" class="text-darkblue"><i class="fas fa-plus"></i></a>
                    </h3>
                </div>
                <div class="col-12">
                                ...
                                foreach ($user as $row) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= site_url('manajemen/kategori_pengguna/ubah/' . html_escape($row['id'])) ?>" class='btn btn-sm fas fa-edit text-primary' data-toggle="tooltip" data-placement="top" title="Ubah"></a>
                                            <a href="#" class='btn btn-sm fas fa-trash-alt text-primary' onclick="deleteConfirm(' <?= site_url('manajemen/kategori_pengguna/hapus/' . html_escape($row['id'])) ?>')" data-toggle="tooltip" data-placement="top" title="Hapus"></a>
                                        </td>
                                    </tr>
                                <?php $number++;
                                endforeach; ?>
